    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <?php echo '<img src="'.get_template_directory_uri().'/images/one.png" alt="Dog Sitter. Marina District, San Diego">'; ?>
            ...
            <div class="swiper-slide">
                <?php echo '<img src="'.get_template_directory_uri().'/images/two.png" alt="Dog Sitter. Cortez Hill, San Diego">'; ?>
            ...
            <div class="swiper-slide">
                <?php echo '<img src="'.get_template_directory_uri().'/images/three.png" alt="Dog Sitter. East Village, San Diego">'; ?>
            ...
            <div class="swiper-slide">
                <?php echo '<img src="'.get_template_directory_uri().'/images/four.png" alt="Dog Sitter. La Mesa, San Diego">'; ?>
                <div class="owner-details"><!--&quot;Sara looked after our lovely Lucy for a couple of days when we went on vacation. We're so grateful to her for being such a great sitter. &quot; - Ron, La Mesa.--></div>
            </div>
        </div>
    </div>
