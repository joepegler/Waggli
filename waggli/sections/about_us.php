    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <?php echo '<img src="'.get_template_directory_uri().'/images/one.png">'; ?>
            ...
            <div class="swiper-slide">
                <?php echo '<img src="'.get_template_directory_uri().'/images/two.png">'; ?>
            ...
            <div class="swiper-slide">
                <?php echo '<img src="'.get_template_directory_uri().'/images/three.png">'; ?>
            ...
            <div class="swiper-slide">
                <?php echo '<img src="'.get_template_directory_uri().'/images/four.png">'; ?>
