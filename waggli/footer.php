			...
			<footer id="footer" role="contentinfo">
				...
				<div class="container">
					...
					<nav class="ij-effect-9">
						...
						<a href="http://maps.google.com/?q=San Diego, CA 92121"><span> <?php echo '<img src="'.get_template_directory_uri().'/images/location.png">'?></span><span> San Diego, CA 92121 </span></a>
						...
						<a href="tel: (619) 940-7364"><span> <?php echo '<img src="'.get_template_directory_uri().'/images/phone.png">'?></span><span> (619) 940-7364 </span></a>
