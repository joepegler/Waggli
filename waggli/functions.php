...
function zerif_scripts() {    
    ...
    /* Datepicker script */
    wp_enqueue_script('my_datepicker_script', get_template_directory_uri() . '/js/datepicker.js', array(), '20120206', true);
    ...
    wp_enqueue_script('my_custom_script', get_template_directory_uri() . '/js/custom.js', array(), '20120206', true);

    wp_enqueue_script('swiper_script', get_template_directory_uri() . '/js/swiper.min.js', array(), '20120206', true);
